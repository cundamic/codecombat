module.exports = nativeDescription: "slovenčina", englishDescription: "Slovak", translation:
  ...
  diplomat_suggestion:
    ...
    pitch_body: "CodeCombat je vyvíjaný v angličtine, ale  hrajú ho hráči na celom svete. Niektorí z nich by dali prednosť slovenčine. Ak ovládaš oba jazyky, zaregistruj sa ako Diplomat a pomôž preložiť webovú stránku CodeCombat a všetky úrovne do slovenčiny."
    missing_translations: "Pokiaľ nepreložíme všetko do slovenčiny, na nepreložených miestach bude text v angličtine."
  ...
  play_level:
    ...
    victory_viking_code_school: "Prepánakráľa, dokončil si práve ťažkú úroveň! Ak už nie si softvérový vývojár, tak by si ním mal byť. Môžeš byť okamžite prijatý do Vikingskej školy kódovania, kde sa môžeš posunúť v kódovaní na novú úroveň. Za 14 týždňov sa  staneš profesionálnym webovým vývojarom."
    ...
    infinite_loop_title: "Zistená nekonečná slučka"
    infinite_loop_description: "Kód beží donekonečna, je buď veľmi pomalý alebo obsahuje nekonečnú slučku. Je možná aj chyba v programe. Skús spustiť kód znovu alebo zresetuj kód do počiatočného stavu. Ak to nepomôže, spoj sa s nami."
    check_dev_console: "Môžem tiež otvoriť Konzolu pre vývojara a pozrieť sa, kde je problém."
    check_dev_console_link: "(návod)"
    ...
    tip_free_your_mind: " Zbav sa všetkého, Neo. Zbav sa strachu, pochybností a nedôvery. Osloboď svoju myseľ. - Morpheus"
    tip_strong_opponents: "Každý, aj ten najsilnejší súper má slabosť. - Itachi Uchiha"
  ...
  subscribe:
    ...
    thank_you: "Ďakujeme za podporu pre CodeCombat."
    sorry_to_see_you_go: "Je nám ľúto, že odchádzaš ! Daj nám vedieť, čo by sme mali urobiť lepšie."
    unsubscribe_feedback_placeholder: "Ó, čo sme ti urobili ?"
    parent_button: "Spýtaj sa rodičov"
    parent_email_description: "Napíšeme im email, aby ti mohli kúpiť predplatné pre  CodeCombat."
    parent_email_input_invalid: "Neplatná emailová adresa."
    parent_email_input_label: "Emailová adresa rodičov"
    parent_email_input_placeholder: "Napíš rodičovský email"
    parent_email_send: "Odoslať email"
